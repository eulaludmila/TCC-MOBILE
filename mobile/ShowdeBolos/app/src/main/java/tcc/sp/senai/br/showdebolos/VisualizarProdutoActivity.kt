...
class VisualizarProdutoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Picasso.with(expandedImage.context).load("http://54.242.6.253${produto.foto}").into(expandedImage)
        Picasso.with(img_confeiteiro_visualizar.context).load("http://54.242.6.253${produto.confeiteiro.foto}").into(img_confeiteiro_visualizar)
