...
class PedidosAguardandoRespostaFragment : Fragment() {
    ...
    fun CarregarPedidos(pedidos: List<Pedido>, view: View ){
    ...
    fun CarregarRecyclerView(view: View){
        ...
        callPedido.enqueue(object : retrofit2.Callback<List<Pedido>>{
            ...
            override fun onResponse(call: Call<List<Pedido>>, response: Response<List<Pedido>>) {
                ...
                if(listaPedidos != null){
                    Log.d("ITEMS_PEDIDO", listaPedidos.toString())
                    CarregarPedidos(listaPedidos, view)
                    Log.d("CODIGO_CONFEITEIRO",sharedPreferences!!.getString("codUsuario", "").toString())
                }
